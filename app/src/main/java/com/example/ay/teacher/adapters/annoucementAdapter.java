...
import com.example.ay.teacher.Message;
import com.example.ay.teacher.R;
import com.example.ay.teacher.helper.FlipAnimator;
...
public class annoucementAdapter extends RecyclerView.Adapter<annoucementAdapter.MyViewHolder> {
    ...
    public annoucementAdapter(Context mContext, List<Message> messages, MessageAdapterListener listener) {
